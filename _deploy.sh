...
#build pdf book
/usr/bin/pandoc --latex-engine=xelatex --template latex/phd_thesis_template.tex --natbib --variable tables=yes --standalone --bibliography=book.bib 01-summary.md 02-acknowledgements.md toc.md 03-intro.md 04-methods.md  -o pdf/PhD_thesis_Susann_Vorberg.pdf
