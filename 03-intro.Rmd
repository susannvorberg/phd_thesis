...
It took until the end of the last decade that major sources of noise could be eliminated [@Dunn2008; @Weigt2009].
...
Several methods use correlation coefficient based measures, like Pearson correlation of amino acid counts or properties associated with amino acids at the sites of a [MSA](#abbrev) such as mutational propensities [@Neher1994; @Taylor1994; @Gobel1994; @Oliveira2002]. 

Many methods have been developed that are rooted in information theory and use [MI](#abbrev) measures to describe the dependence between sites in the alignment [@Clarke1995; @Korber1993; @Martin2005].
Phylogenetic and entropy biases have been identified as the major sources of noise that confound the true coevolution signal [@Atchley2000; @Fodor2004; @Martin2005].
...
The most prominent correction for background noises is [APC](#apc), developed by Dunn et al. [@Dunn2008] that drastically removes background noise from entropic effects and is discussed in section  \@ref(post-processing-heuristics).
...
direct from indirect couplings has been referred to in the literature as DCA.
...
*mpDCA* [@Weigt2009] and *mfDCA* [@Morcos2011; @Marks2011] employ a score called [DI](#abbrev), which has quickly been replaced by the Frobenius norm as it was found to improve prediction performance over [DI](#abbrev) [@Ekeberg2013; @Baldassi2014].
