...
The most prominent correction for background noises is [APC](#apc), developed by Dunn et al. that drastically removes background noise from entropic effects and is discussed in section  \@ref(post-processing-heuristics) [@Dunn2008].
...
In fact, most global statistical approaches can be reformulated in the light of maximum entropy models.  
Only Burger and Nijmwegen developed a global statistical model very different from the maximum entropy approach. 
Their Bayesian network model uses informative priors to improve precision [@Burger2010]. 
