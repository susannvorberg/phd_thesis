...
Even though pseudo-likelihood has been shown to be a consistent estimator of the true likelihood estimates in the limit of large datasets [@Besag1975 @Aurell2012], it is not clear how well pseudo-likelihood approximation is for small data.
