...
Using this learning rate defined as a function of [Neff](#bbrev), precision improves over the previous fixed learning rates (brown line in Figure \@ref(fig:performance-cd-alphaopt)).
