...
- evidence for a coupling $\wijab$ from the alignment, $N_{ij} \cdot q_i(a)  \cdot q_j(b) \ge 100$ with:
    - $N_{ij}$: number of sequences with neither a gap at position $i$ nor at position $j$
...
| Wang et al. (2011) [@Wang2011] | RandomForest | 1 : 4 |
| DiLena et al. (2012) [@DiLena2012a] | deep neural network| 1 : ~4 (sampling 20% of non-contacts) |
| Wang et al. (2013) [@Wang2013] | Random Forest |  1 : ~4 (sampling 20% of non-contacts) |
