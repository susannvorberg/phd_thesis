...
```{r performance-cd-alphaopt, echo = FALSE, screenshot.alt="img/full_likelihood/alpha_opt_precision_vs_rank_notitle.png", out.width = '90%', fig.align='center', fig.cap = '(ref:caption-performance-cd-alphaopt)'}
...
```{r avg-nr-contacts-per-residue-vs-protein-length, echo = FALSE, screenshot.alt="img/random_forest_contact_priornumber_contacts_per_residue_vs_protein_length.png", out.width = '80%', fig.align='center', fig.cap = '(ref:caption-avg-nr-contacts-per-residue-vs-protein-length)'}
...
```{r feature-importance-rf-with-pll-score, echo = FALSE, screenshot.alt="img/random_forest_contact_prior/ffeature_plll2norm_random_forest_nestimators1000_maxfeaturesauto_251features_top.png",out.width = '90%', fig.align='center', fig.cap = '(ref:caption-feature-importance-rf-with-pll-score)'}
