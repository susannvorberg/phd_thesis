...
```{r gradient-directions, echo = FALSE, screenshot.alt="img/full_likelihood/sgd/percentage_changes_in_gradient_direction.png", out.width = '50%', fig.align='center', fig.show='hold', fig.cap = '(ref:caption-gradient-directions)'}
