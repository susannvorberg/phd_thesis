...
For example, for protein 1ss3A00 (protein length=50, [Neff](#abbrev)=36), [CD](#abbrev) makes strong predictions for all pairing of the residues (8, 12, 16, 26, 30, 34) (see Figure \@ref(fig:cd-predictions-small-neff-proteins)).
Five of the predicted contacts are actually true contacts. 
Taking a loot at the structure it is revealed that these positions are disulfid bonds which are strongly conserved.
Another example protein 1c55A00 (protein length = 40, Neff = 88) for which [CD](#abbrev) makes strong predictions for pairings beetween residues (10, 16, 20, 31, 36, 38).
Again, it turns out that the five true positive predictions are disulfid bonds (see right plot in Figure \@ref(fig:cd-predictions-small-neff-proteins)).
...
However, the predictions made by [CD](#abbrev) are rather atypical in a sense that coevolution methods cannot detect signals from fully conserved columns without variation. 
