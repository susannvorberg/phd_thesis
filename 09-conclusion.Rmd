...
Nevertheless, the Bayesian framework developed here provides a solid theoretical and statistically sound formulation for [DCA](#abbrev) with enhanced explanatory power compared to the uninformative heuristics. 
