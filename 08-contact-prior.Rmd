...
```{r rf-feature-importance, echo = FALSE, screenshot.alt="img/random_forest_contact_prior/feature-importance-rf.png", out.width = '100%', fig.cap = '(ref:caption-rf-feature-importance)'}
...
```{r rf-performance-feature-selection, echo = FALSE, screenshot.alt="img/random_forest_contact_prior/feature-selection-rf.png", out.width = '100%', fig.cap = '(ref:caption-rf-performance-feature-selection)'}
