...
It has long been known that a protein 3D structure can be reconstructed from a native contact map [@Vendruscolo1997].
Also, protein fold reconstruction from inter-residue proximity constraints obtained from experiments such as cross-linking/mass spectrometry, fluorescence resonance energy transfer (FRET) or sparse nuclear Overhauser enhancement (NOE) distance data generated from NMR experiments has been demonstrated [@Li2004; @Li2003a; @Aszodi1995a].
...
There are ongoing discussions about the necessary quality of predictions and how to effectively utilize the inferred contact information.
It has long been known that only a subset of native contacts is sufficient to produce accurate structural models [@Konopka2014; @Vendruscolo1997; @Sathyapriya2009; @Chen2007; @Vassura2007]. 
Sathyapriya and colleagues showed that 8% of native contacts selected according to a rational strategy helps to reconstruct the structure to near native resolution, otherwise 20-30% of randomly selected contacts are sufficient [@Sathyapriya2009].
...
A consistent finding is that long-range contacts are more important than short-range contacts for structure reconstruction, even though their information alone is not sufficient [@Sathyapriya2009; @Kosciolek2014; @DiLena2009a].
Long-range contacts are rare and most informative for protein structure prediction because they define the overal fold and packing of tertiary structure whereas short-range contacts define local secondary structure.
Apart from accuracy and distribution of predicted contacts, model quality depends on many other factors such as the secondary structure composition of the structure, other sources of information used, the type of distance constraint function and the structure reconstruction protocol.
