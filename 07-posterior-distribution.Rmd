...
## Training the model parameters $\muk$ and $\Lk$ {#bayesian-model-training-hyperparameters}

The model hyperparameters $\muk$ and $\Lk$ representing the mean and precision matrices of the K Gaussian components of the contact state dependent coupling prior, will be trained via maximum-likelihood estimation as described in detail in method section \@ref(training-hyperparameters).
