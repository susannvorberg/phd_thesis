...
Bayesian likelihood, that involves marginalizing out the coupling
parameters, with prior information in form of the random forest contact
class probabilities. The precision of the contacts that are assigned the
highest probabilities did not improve over precision of the heuristic
...
can be easily extended to include further prior information or that can
be embedded in further Bayesian hierarchies. For example, a simple
extension of the Bayesian model allows the estimation of posterior
probabilities of residue-residue distances instead of contacts (see
section \ref{bayesian-model-distances}). The analysis in chapter
