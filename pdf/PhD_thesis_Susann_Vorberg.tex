...
chain
{[}\protect\hyperlink{ref-Bengio2009}{189},\protect\hyperlink{ref-Ma2016}{198}{]}.
...
increase {[}\protect\hyperlink{ref-Tieleman2008}{199}{]}. This can lead
...
optimization progresses {[}\protect\hyperlink{ref-Fischer2010}{200}{]}.
...
model parameters increase {[}\protect\hyperlink{ref-Bengio2009}{189}{]}.
...
{[}\protect\hyperlink{ref-Hyvarinen2006}{201},\protect\hyperlink{ref-Hyvarinen2007}{202}{]}.
...
blocked-Gibbs sampling {[}\protect\hyperlink{ref-Asuncion2010}{203}{]}.
...
{[}\protect\hyperlink{ref-Tieleman2008}{199}{]}. Instead, the Markov
...
distribution
{[}\protect\hyperlink{ref-Murphy2012}{92},\protect\hyperlink{ref-Fischer2012}{188},\protect\hyperlink{ref-Tieleman2008}{199}{]}.
...
{[}\protect\hyperlink{ref-Murphy2012}{92},\protect\hyperlink{ref-Tieleman2008}{199},\protect\hyperlink{ref-Swersky2010}{204}{]}.
...
{[}\protect\hyperlink{ref-Bengio2009}{189},\protect\hyperlink{ref-Tieleman2008}{199}{]}.
...
improve performance {[}\protect\hyperlink{ref-Tieleman2008}{199}{]}.
...
{[}\protect\hyperlink{ref-Tieleman2008}{199},\protect\hyperlink{ref-Swersky2010}{204}{]}.
...
relative change falls below \(\epsilon \eq \mathrm{1e}{-8}\). This also
has the advantage that the model has already approached the optimum and
the parameters \(\w\) will almost be constant over many updates.
...
well. Evolving the Gibbs chains for more than k=1 steps results in a
slight drop in performance, just as it has been observed for
\protect\hyperlink{abbrev}{CD} (Figure \ref{fig:precision-pcd} shows
performance for k=10 steps). Optimizing the full likelihoood with
...
In contrast to the findings in literature, neither
...
{[}\protect\hyperlink{ref-Swersky2010}{204}{]}. They found many
...
{[}\protect\hyperlink{ref-Kingma2014}{205}{]}.
...
{[}\protect\hyperlink{ref-Ruder2017}{190},\protect\hyperlink{ref-Kingma2014}{205}{]}.
...
{[}\protect\hyperlink{ref-Chollet2015}{206}{]} and
\href{https://github.com/Lasagne/Lasagne/blob/master/lasagne/updates.py\#L565-L629}{Lasagne}
{[}\protect\hyperlink{ref-Dieleman2015}{207}{]} packages allow the use
...
optimization for the stochastic gradient decent optimizer and
hyperparameters of the \protect\hyperlink{abbrev}{CD} model itself.
...
\protect\hyperlink{abbrev}{CD}-1. \protect\hyperlink{abbrev}{CD}-1
generates sequence samples according to the current state of the model
by evolving Gibbs chains, that have been initialized at data samples,
for one full step. Eventhough, the \emph{ADAM} optimizer did not improve
perfomance, it is still likely that appropriate modifications of the
optimization procedure might lead to improvments, e.g.~averaging
{[}\protect\hyperlink{ref-Ma2016}{198}{]}. As dicussed in section
\ref{convergence-criteria-sgd}, the convergence criterion is a crucial
aspect for optimization, not only affecting runtime but also preventing
overfitting. It might be worth to assess convergence with more
sophisticated metrics than the L2 norm of the coupling parameters,
\(||\w||_2\), liek the EB-criterion proposed by Mahsereci et al.
{[}\protect\hyperlink{ref-Mahsereci2017}{196}{]}. Interestingly, better
gradient estimates that were obtained by running more Gibbs chains in
parallel (see section \ref{cd-sampling-size}), did not carry over to
better predictive performance. It can be speculated that the heuristic
contact score, computed as the \protect\hyperlink{abbrev}{APC} corrected
Frobenius norm of the couplings, that has empirically been found to work
very well for pseudo-likelihood couplings, might not be an appropriate
choice for couplings computed with \protect\hyperlink{abbrev}{CD}.
Furthermore, it is possible that the improved gradient, obtained by
generating more samples, helps to finetune the parameters which has no
effect on the contact score and the ovaral ranking of residue pairs.
...
A final benchmark over a larger set of proteins (2000 proteins from
subsets 9 and 10 from dataset described in method section \ref{dataset})
...
{\centering \includegraphics[width=0.48\linewidth]{img/full_likelihood/comparing_couplings/1c75A00/contact_map_pseudo-likelihood_apc_1c75A00} \includegraphics[width=0.48\linewidth]{img/full_likelihood/comparing_couplings/1c75A00/contact_map_contrastive_divergence_apc_1c75A00} 
...
distribution are very similar. A detailed view of the top ranked
predictions is given in the right plot in Figure
\ref{fig:ranking-pll-cd-1c75a00}. The three most confident predictions
are identical for both methods. Yet, the ranks of subsequent predictions
are swapped by only a few positions which was already evident from the
contact maps.
...
\subsection{Protein 1ahlA01}\label{protein-1ahla01}

Proteins with very low Neff often have higher precision with CD.
...
\caption{better for small N}\label{fig:precision-cd-final-neff}
\end{figure}
...
{[}\protect\hyperlink{ref-Jones2015a}{82},\protect\hyperlink{ref-He2017}{85},\protect\hyperlink{ref-Ma2015a}{208}{]}.
...
of overfitting {[}\protect\hyperlink{ref-Louppe2014}{213}{]}. It is
...
respectively {[}\protect\hyperlink{ref-Menze2009}{212}{]}. The feature
...
{[}\protect\hyperlink{ref-Strobl2007}{214}{]}.
...
{[}\protect\hyperlink{ref-Bernard2009}{215}{]}. Stochasticity introduced
...
{[}\protect\hyperlink{ref-Louppe2014}{213}{]}
...
{[}\protect\hyperlink{ref-Fodor2004a}{216}{]} and
...
{[}\protect\hyperlink{ref-Miyazawa1999a}{217}{]} and
...
Netsurfp (v1.0) {[}\protect\hyperlink{ref-Petersen2009a}{218}{]} for
...
{[}\protect\hyperlink{ref-Jones1999}{219}{]} computed within a window of
...
irrelevant features {[}\protect\hyperlink{ref-Menze2009}{212}{]}. For
...
{[}\protect\hyperlink{ref-Fodor2004a}{216}{]}. \textbf{mutual
...
{[}\protect\hyperlink{ref-Sillitoe2015}{220}{]} database for
...
(v4.0){[}\protect\hyperlink{ref-Jones1999}{219}{]} given as average
...
(v1.0){[}\protect\hyperlink{ref-Petersen2009a}{218}{]} given as average
three state propensities\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\centering\strut
3\strut
\end{minipage}\tabularnewline
...
{[}\protect\hyperlink{ref-Jones1999}{219}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\centering\strut
6\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedleft\strut
...
{[}\protect\hyperlink{ref-Petersen2009a}{218}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\centering\strut
6\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedleft\strut
...
{[}\protect\hyperlink{ref-Miyazawa1999a}{217}{]}. Data taken from
...
\end{minipage} & \begin{minipage}[t]{0.50\columnwidth}\raggedright\strut
according to Fodor\&Aldrich
{[}\protect\hyperlink{ref-Fodor2004a}{216}{]} with and without
\protect\hyperlink{abbrev}{APC}\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\centering\strut
2\strut
\end{minipage}\tabularnewline
...
\section{Defining the initial learning rate as a function of
Neff}\label{defining-the-initial-learning-rate-as-a-function-of-neff}
...
The following figures show the mean precision over the validation set
for contacts computed from \protect\hyperlink{abbrev}{CD} with
stochastic gradient descent and using different learning rate annealing
schedules
...
The following Figures show the distribution of the number of iterations
until convergence over the validation dataset for stochastic gradient
descent optimization of \protect\hyperlink{abbev}{CD} for different
...
\section{Monitoring Optimization for Protein 1aho for Different Sample
Sizes}\label{monitoring-optimization-for-protein-1aho-for-different-sample-sizes}
...
\section{Using ADAM with different learning rates and anneaing
schedules}\label{using-adam-with-different-learning-rates-and-anneaing-schedules}
...
\section{Comparing Pseudo-Likelihood and Contrastive Divergence for
1c75A00}\label{comparing-pseudo-likelihood-and-contrastive-divergence-for-1c75a00}
...
\caption{Proteins with the 20th largest \protect\hyperlink{abbrev}{Neff}
values from the dataset of 300 proteins used to evaluate
\protect\hyperlink{abbrev}{CD}. Statistics have been computed for the
contact scores computed from pseudo-likelihood couplings and
\protect\hyperlink{abbrev}{CD} couplings. Contact scores are computed as
the \protect\hyperlink{abbrev}{APC} corrected Frobenius norm of the
couplings \(\wij\). \protect\hyperlink{abbrev}{CD} coupling parameters
have been optimized with \protect\hyperlink{abbrev}{SGD} using the
following hyperparameter settings: simgoidal learning rate schedule with
initial learning rate \(\alpha_0 = \frac{5e-2}{\sqrt{N_{\text{eff}}}}\)
and decay rate \(\gamma = 5e-6\). Regularization coefficient
\(\lambda_w = 0.1L\). In order to approximate the gradient with
\protect\hyperlink{abbrev}{CD}, 0.3Neff sequences are randomly selected
and evolved with a Gibbs chain for 1 step.}\tabularnewline
\toprule
...
spearman rho\strut
\end{minipage} & \begin{minipage}[b]{0.09\columnwidth}\raggedright\strut
spearman pvalue\strut
\end{minipage} & \begin{minipage}[b]{0.11\columnwidth}\raggedright\strut
kolmogorov-smirnov\strut
\end{minipage} & \begin{minipage}[b]{0.11\columnwidth}\raggedright\strut
kolmogorov-smirnov pvalue\strut
\end{minipage}\tabularnewline
\midrule
\endfirsthead
\toprule
...
\begin{longtable}[]{@{}lllllll@{}}
\caption{Proteins with the 20th smallest
\protect\hyperlink{abbrev}{Neff} values from the dataset of 300 proteins
used to evaluate \protect\hyperlink{abbrev}{CD}. Statistics have been
computed for the contact scores computed from pseudo-likelihood
couplings and \protect\hyperlink{abbrev}{CD} couplings. Contact scores
are computed as the \protect\hyperlink{abbrev}{APC} corrected Frobenius
norm of the couplings \(\wij\). \protect\hyperlink{abbrev}{CD} coupling
parameters have been optimized with \protect\hyperlink{abbrev}{SGD}
using the following hyperparameter settings: simgoidal learning rate
schedule with initial learning rate
\(\alpha_0 = \frac{5e-2}{\sqrt{N_{\text{eff}}}}\) and decay rate
\(\gamma = 5e-6\). Regularization coefficient \(\lambda_w = 0.1L\). In
order to approximate the gradient with \protect\hyperlink{abbrev}{CD},
0.3Neff sequences are randomly selected and evolved with a Gibbs chain
for 1 step.}\tabularnewline
\toprule
\begin{minipage}[b]{0.08\columnwidth}\raggedright\strut
protein\strut
\end{minipage} & \begin{minipage}[b]{0.06\columnwidth}\raggedright\strut
...
{[}\protect\hyperlink{ref-Miyazawa1999a}{217}{]}. \textbf{OMES+APC}:
\protect\hyperlink{abbrev}{APC} corrected OMES score according to
Fodor\&Aldrich {[}\protect\hyperlink{ref-Fodor2004a}{216}{]}.
\textbf{mean pair potential (Li\&Fang)}: average general contact
potential by Li \& Fang {[}\protect\hyperlink{ref-Li2011}{67}{]}.
...
198. Ma, X., and Wang, X. (2016). Average Contrastive Divergence for
...
199. Tieleman, T. (2008). Training Restricted Boltzmann Machines using
Approximations to the Likelihood Gradient. Proc. 25th Int. Conf. Mach.
Learn. \emph{307}, 7.

\hypertarget{ref-Fischer2010}{}
200. Fischer, A., and Igel, C. (2010). Empirical Analysis of the
...
201. Hyvärinen, A. (2006). Consistency of pseudolikelihood estimation of
...
202. Hyvarinen, A. (2007). Connections Between Score Matching,
...
203. Asuncion, A.U., Liu, Q., Ihler, A.T., and Smyth, P. (2010).
...
204. Swersky, K., Chen, B., Marlin, B., and Freitas, N. de (2010). A
...
206. Chollet, F. and others (2015). Keras. Available at:
\url{https://github.com/fchollet/keras}.

\hypertarget{ref-Dieleman2015}{}
207. Dieleman, S., Schlüter, J., Raffel, C., Olson, E., Sønderby, S.K.,
...
208. Ma, J., Wang, S., Wang, Z., and Xu, J. (2015). Protein contact
...
209. Ho, T.K. (1998). The random subspace method for constructing
...
213. Louppe, G. (2014). Understanding Random Forests: From Theory to
Practice. Available at: \url{http://arxiv.org/abs/1407.7502}.

\hypertarget{ref-Strobl2007}{}
214. Strobl, C., Boulesteix, A.-L., Zeileis, A., and Hothorn, T. (2007).
...
215. Bernard, S., Heutte, L., and Adam, S. (2009). Influence of
...
216. Fodor, A.A., and Aldrich, R.W. (2004). Influence of conservation on
calculations of amino acid covariance in multiple sequence alignments.
Proteins \emph{56}, 211--21. Available at:
\url{http://www.ncbi.nlm.nih.gov/pubmed/15211506}.

\hypertarget{ref-Miyazawa1999a}{}
217. Miyazawa, S., and Jernigan, R.L. (1999). Self-consistent estimation
...
218. Petersen, B., Petersen, T.N., Andersen, P., Nielsen, M., and
...
219. Jones, D.T. (1999). Protein secondary structure prediction based on
...
220. Sillitoe, I., Lewis, T.E., Cuff, A., Das, S., Ashford, P., Dawson,
